...
class VersionTest(unittest.TestCase):
    ...
    def test_a_released_build_carries_its_number_and_nothing_else(self):
        self.assertEqual(version.stamped("dungeon-master", "1.2.3"), "dungeon-master-v1.2.3.sfc")

    def test_an_unreleased_build_says_so_in_its_name(self):
...
class ReleaseWiringTest(unittest.TestCase):
    ...
    def test_the_script_matches_the_assignment_the_module_actually_uses(self):
