...
def write_trace(path: Any, records: Any) -> None:
...
class RecordTest(unittest.TestCase):
    ...
    def test_a_record_round_trips_every_field(self) -> None:
        write_trace(
    ...
    def test_a_truncated_tail_is_refused_rather_than_guessed(self) -> None:
    ...
    def test_the_feed_bank_comes_from_the_block_move_operand(self) -> None:
    ...
    def test_a_byte_written_by_an_ordinary_store_reports_no_block_move(self) -> None:
        write_trace(self.path, [record(dt.KIND_WRITE, 0x01)])
...
class StateMachineTest(unittest.TestCase):
    ...
    def test_the_boot_sync_is_a_command_with_no_payload(self) -> None:
    ...
    def test_a_multiply_carries_four_parameters_and_four_outputs(self) -> None:
    ...
    def test_a_tile_conversion_carries_thirty_two_each_way(self) -> None:
    ...
    def test_the_transparent_colour_takes_one_parameter_and_returns_nothing(self) -> None:
    ...
    def test_a_merge_reads_its_length_then_twice_that_many_parameters(self) -> None:
        found = self.transactions_of(
    ...
    def test_a_mirror_reads_its_length_then_that_many_parameters(self) -> None:
        found = self.transactions_of(
    ...
    def test_a_scale_reads_two_lengths_then_half_of_each_rounded_up(self) -> None:
        found = self.transactions_of(
    ...
    def test_two_transactions_in_a_row_are_kept_apart(self) -> None:
    ...
    def test_a_transaction_left_open_at_the_end_is_reported_as_incomplete(self) -> None:
...
class SourceTest(unittest.TestCase):
    ...
    def test_a_block_moved_run_reports_its_source_address(self) -> None:
        block = [
    ...
    def test_a_run_written_one_byte_at_a_time_has_no_source_address(self) -> None:
        found = self.transactions_of(
    ...
    def test_a_source_in_work_ram_is_told_apart_from_one_in_rom(self) -> None:
        rom_block = [
...
class SummaryTest(unittest.TestCase):
    ...
    def test_counts_are_grouped_by_command(self) -> None:
    ...
    def test_the_program_counters_that_issue_commands_are_collected(self) -> None:
...
class ReportTest(unittest.TestCase):
    ...
    def test_and_one_outside_it_is_named_as_rom(self) -> None:
    ...
    def test_a_command_with_no_name_is_printed_by_its_number(self) -> None:
        found = dt.report(self._summary(writes([0x42])))

        self.assertIn("op42", found)

    def test_the_length_tuples_a_run_used_are_counted(self) -> None:
...
class WorkRamTest(unittest.TestCase):
    def test_the_two_work_ram_banks_are_known_as_such(self) -> None:
        self.assertTrue(dt.is_work_ram(0x7E))
        self.assertTrue(dt.is_work_ram(0x7F))

    def test_and_a_rom_bank_is_not(self) -> None:
...
class PayloadSizeTest(unittest.TestCase):
    ...
    def test_a_merge_takes_twice_its_length_and_gives_its_length(self) -> None:
        self.assertEqual(dt._payload_sizes(0x05, (4,)), (8, 4))

    def test_a_mirror_takes_and_gives_its_length(self) -> None:
        self.assertEqual(dt._payload_sizes(0x06, (4,)), (4, 4))

    def test_a_scale_takes_and_gives_half_of_each_length_rounded_up(self) -> None:
        self.assertEqual(dt._payload_sizes(0x0D, (5, 9)), (3, 5))

    def test_both_scale_lengths_count_nibbles_rather_than_bytes(self) -> None:
    ...
    def test_a_command_that_declares_no_length_is_refused(self) -> None:
...
class StreamEdgeTest(unittest.TestCase):
    ...
    def test_a_read_before_any_command_is_passed_over(self) -> None:
        found = self._walk(reads([0xFF]) + writes([0x0F]))

        self.assertEqual(len(found), 1)
        self.assertEqual(found[0].command, 0x0F)

    def test_a_length_of_zero_finishes_the_command_where_it_stands(self) -> None:
    ...
    def test_a_read_arriving_before_the_input_is_done_is_passed_over(self) -> None:
    ...
    def test_a_command_that_answers_without_taking_anything_is_complete(self) -> None:
        found = self._walk(writes([0x0F]))

        self.assertTrue(found[0].complete)

    def test_a_command_nobody_recognises_takes_nothing_and_gives_nothing(self) -> None:
